...
% \]
%
\mg{This wording needs to be fixed. Also notice that the type is wrong, a label is not always returned.} The Latest Label $\llabel : \mathcal{T} \to \mathcal{VAR} \to \mathbb{N}$ 
The label of the latest assignment event which assigns value to variable $x$.
\[
  \begin{array}{lll}
