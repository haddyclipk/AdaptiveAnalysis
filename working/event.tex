...
\mg{Two} \sout{2} query expressions $\qexpr_1$, $\qexpr_2$ are equivalent, denoted as $\qexpr_1 =_{q} \qexpr_2$, if and only if
$$
 \begin{array}{l} 
...
$$
 ...
 %
where $r \in D$ is a record in the database domain $D$,\mg{is  $FV(\qexpr)$ being defined here? If yes, I suggest to put it in a different place, rather than in the middle of another definition.} $FV(\qexpr)$ is the set of free variables in the query expression $\qexpr$.
