...
We use  
%$\mathcal{LVAR} = \mathcal{VAR} \times \mathcal{L} $ represent the universe of all the labeled variables and 
$\avar_c \in \mathcal{P}(\mathcal{VAR} \times \mathbb{N}) \subset \mathcal{VAR} \times \mathcal{L}$ and 
$\lvar_c \in \mathcal{P}(\mathcal{VAR} \times \mathcal{L}) \subseteq \mathcal{VAR} \times \mathcal{L}$ 
represents the the set of assigned variables and labeled variables for a labeled command $lc$, defined in Definition~\ref{def:lvar} and \ref{def:avar}.
%
