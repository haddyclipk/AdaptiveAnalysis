...
This algorithm is written in our {\tt Query While} language in Figure~\ref{fig:linear_regression}(a) as $linearRegression(step, rate)$ taking the iteration number $\kw{step}$ 
